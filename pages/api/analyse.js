...
Return ONLY JSON with crisis, distortions, noDistortionNote, question, evidenceFor, evidenceAgainst, alternative, alternativeNote, and prediction fields. Use prediction null when there is no checkable future claim.`;

    // No key means a private deterministic demo response, not a 500 error.
